            ...
            <div class="block-filter">
                <div class="contain-filter">
                    ...
                    <select name="filter-portfolio-categories" id="filter-portfolio-categories" class="js-href-value">
                        ...
                        <option {{ \App\Helpers\Params::setSelected('category_id', $cat->id) }}
                            value="{{ \App\Helpers\Params::buildUrl($cat->id, 'category_id') }}">{{ $cat->title }}
                        </option>
                        @endforeach
                    </select>
                </div>
    ...
    <div class="row block-content">
        <div class="col-md-8">
            ...
            <div class="item">
                <div class="head">
                    ...
                    <div class="info-portfolio">
                        ...
                        <div class="info-bod">
                            ...
                            <span
                                class="content-item">{{ \App\Helpers\Format::numberFormat($portfolio->reach_number) }}pv
                                / 1ヶ月</span>
                        </div>
                        <div class="info-base">
                            <span class="title-item">再生数</span>
                            <span
                                class="content-item">{{ \App\Helpers\Format::numberFormat($portfolio->view_count) }}回</span>
                        </div>
                        <div class="info-base">
                            <span class="title-item">いいね数</span>
                            <span
                                class="content-item">{{ \App\Helpers\Format::numberFormat($portfolio->like_count) }}件</span>
                        </div>
                        <div class="info-base">
                            <span class="title-item">コメント数</span>
                            <span
                                class="content-item">{{ \App\Helpers\Format::numberFormat($portfolio->comment_count) }}件</span>
                        </div>
                        <div class="info-base">
                            <span class="title-item">CPA</span>
                            <span class="content-item">約
                                {{ \App\Helpers\Format::numberFormat($portfolio->cpa_count) }}</span>
                        </div>
                    </div>
                    <div class="account">
                ...
                <div class="hr"></div>
                <div class="footer">
                    <a class="item-button detail"
                        href="{{ \App\Helpers\Helper::concatStringBySlash(config('common.frontend_url'), $portfolio->u_user_name) }}">詳細</a>
                    <button class="item-button email sendEmailPortfolio" data-user-id="{{ $portfolio->user_id }}"
                        data-user-name="{{ $portfolio->u_given_name }}">メール</button>
                    <div class="contain-filter">
                        <select name="change-status-portfolio" class="change-status-portfolio" data-method="put"
                    ...
                    <div class="contain-filter">
                        <select name="change-active-portfolio" class="change-active-portfolio" data-method="put"
                    ...
                    <a href="{{ route('admin.portfolio.delete', ['id' => $portfolio->id]) }}"
                        ...
                        class="item-button delete js-delete-portfolio">削除</a>
                </div>
            </div>
            @endforeach
